...
namespace API.Controllers
{
     ...
     */
        ...
        [HttpGet]
        public async Task<ActionResult<Pagination<ProductToReturnto>>> GetProducts(
            [FromQuery] ProductSpecParams productParams)
        {
            ...
            return Ok(new Pagination<ProductToReturnto>(productParams.PageIndex, productParams.PageSize, totalItems, data));
        }
